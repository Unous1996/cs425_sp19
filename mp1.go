...
func main() {
	...
	//Get # of participants, user name and port number
	own_name = os.Args[1]
	...
	ready_chan = make(chan bool, num_of_participants)

	//Create ip to timestamp vector index map
	ip_2_vectorindex = map[string]int{
		"172.22.156.52": 0,
		"172.22.158.52": 1,
		"172.22.94.61":  2,
	...
	msg := "NAME" + ";" + own_name
	b := []byte(msg)
	go start_client(num_of_participants, b)

	printReady(ready_chan)
